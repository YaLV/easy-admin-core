        ...
        <nav class="navbar navbar-expand-lg navbar-light">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav flex-column">
                    ...
                    @include('admin.partials.menu', ['menuItemList' => $menuItems])
                    <!--li class="nav-item ">
                        <a class="nav-link {{ Route::getCurrentRoute()->getName()=='dashboard'?'active':'' }}" href="{{ route('dashboard') }}"><i class="fa fa-fw fa-user-circle"></i>Dashboard</a>
                    </li>
                    <li class="nav-item">
